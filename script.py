...
# Converting damages data from string to float and returning converted data as a list:
...
# Creating dictionary of hurricanes with hurricane name as the key and a dictionary of hurricane data as the value:
...
# Converting dictionary with hurricane name as key to a new dictionary with hurricane year as the key and returning new dictionary:
...
# Finding the count of affected areas across all hurricanes and returning as a dictionary with the affected areas as keys:
...
# Writing function to find most affected area and the number of hurricanes it was involved in:
...
# Writing function to find the highest mortality hurricane and the number of deaths it caused:
...
# Write function to catgeorize hurricanes by mortality and return a dictionary:
...
# Function to categorize hurricanes by damage and return a dictionary:
...
# Creating a function to calculate the sustained speed amongh the hurricanes:
def fastest_speed(hurricanes):
    max_speed_cane = ''
    max_speed = 0
    for cane in hurricanes:
        if hurricanes[cane]['Max Sustained Wind'] > max_speed:
            max_speed_cane = cane
            max_speed = hurricanes[cane]['Max Sustained Wind']
        else:
            pass
    return max_speed_cane, max_speed


fastest = fastest_speed(hurricanes)
print(fastest)
